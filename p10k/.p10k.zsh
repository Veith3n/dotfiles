# Generated by Powerlevel10k configuration wizard on 2021-06-14 at 14:28 CEST.
...
typeset -g POWERLEVEL9K_CUSTOM_BITCOIN_PRICE_FOREGROUND=110
# POWERLEVEL9K_CUSTOM_BITCOIN_PRICE="_bitcoin_price"
  ...
  # typeset -g POWERLEVEL9K_BACKGROUND=007
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      # for i in {0..255}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done 
      # run in terminal to see colors
      # Styling for up-to-date Git status.
      local       meta='%f'  # grey foreground
      # local       meta='%244F'  # grey foreground
      # local      clean='%82F'   # green foreground
      local      clean='%76F'   # green foreground
      local   modified='%178F'  # purple foreground
      # local   modified='%127F'  # purple foreground
...
####################################[ time: current time ]#################################### Current time color.
